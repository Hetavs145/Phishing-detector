    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center">
          <motion.h1
            className="text-4xl font-bold bg-gradient-to-r from-cyber-blue to-cyber-pink bg-clip-text text-transparent"
        ...
        >
          ...
          <div className="mt-6">
            ...
            <motion.button
              ...
              disabled={loading}
              className="mt-4 w-full py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <Link
                to="/signup"
                className="text-cyber-blue hover:text-cyber-pink transition-colors duration-200 font-semibold"
              >
                Sign up
              </Link>
            </p>
